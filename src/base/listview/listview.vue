<template>
    <scroll class="listview" :data="data" ref="listview" :listenScroll="listenScroll" @scroll="scroll" :probeType="probeType">
        ...
        <div class="list-shortcut" @touchstart="onShortcutTouchStrat" @touchmove.stop.prevent="onShortcutTouchMove">
            <ul>
                <li 
    ...
    export default{
        ...
        methods: {
            ...
            onShortcutTouchMove(e){
                ...
                let delta = (this.touch.y2 - this.touch.y1) / ANCHOR_HEIHGT | 0
